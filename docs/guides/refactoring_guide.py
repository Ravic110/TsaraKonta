...
MAPPING = {
    "ORIGINAL (apifactorise.py)": {
        ...
        "DialogueLigne": "→ ui/journal_dialogs.py",
        "ComptabiliteApp": "→ ui/comptabilite_app.py"
    }
}
...
MIGRATION_CHECKLIST = [
    ...
    "✅ Classe DialogueLigne → ui/journal_dialogs.py",
    "✅ Classe ComptabiliteApp → ui/comptabilite_app.py",
