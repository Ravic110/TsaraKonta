...
Je veux comprendre l'architecture    → README.md ou docs/guides/architecture_guide.py
Je veux des exemples de code         → docs/guides/usage_examples.py
Je veux commencer simplement          → docs/guides/quickstart_guide.py
Je veux valider la structure          → docs/guides/import_smoke_tests.py
Je veux voir les détails importants  → docs/guides/project_summary.py
Je veux comprendre la migration       → docs/guides/migration_mapping.py ou docs/guides/refactoring_guide.py
...
📄 main.py
   ...
   └─ IMPORTE: ui.comptabilite_app.ComptabiliteApp
...
📄 docs/guides/usage_examples.py
   ...
   ├─ LANCER: python docs/guides/usage_examples.py
   └─ LIRE SI: Vous voulez des exemples de code

📄 docs/guides/architecture_guide.py
   ...
   ├─ LANCER: python docs/guides/architecture_guide.py
...
📄 docs/guides/refactoring_guide.py
   ...
   ├─ LANCER: python docs/guides/refactoring_guide.py
   └─ LIRE SI: Vous voulez comprendre pourquoi c'est mieux

📄 docs/guides/project_summary.py
   ...
   │   ├─ Statistiques
   │   └─ Checklist final
   ├─ LANCER: python docs/guides/project_summary.py
   └─ LIRE SI: Vous voulez une vue d'ensemble rapide

📄 docs/guides/migration_mapping.py
   ...
   ├─ LANCER: python docs/guides/migration_mapping.py
...
📄 docs/guides/import_smoke_tests.py
   ...
   │   ├─ Tests d'utilitaires
   │   └─ Tests de structure
   ├─ LANCER: python docs/guides/import_smoke_tests.py
...
Pour les curieux (30 min):
  ...
  2. python docs/guides/quickstart_guide.py              → Menu interactif
  3. Choisir option 4                  → Voir les exemples
  4. python docs/guides/usage_examples.py                → Copier les exemples

Pour les développeurs (1-2 heures):
  1. Lire docs/guides/architecture_guide.py              → Voir l'architecture
  2. Lire docs/guides/migration_mapping.py                   → Où est chaque élément
  3. Lire les fichiers source:
     - config.py (5 min)
     - models/data.py (10 min)
     - ui/comptabilite_app.py (15 min)
     - ui/journal_dialogs.py (15 min)
     - utils/formatters.py (5 min)
  4. python docs/guides/import_smoke_tests.py            → Valider
  5. Créer un script perso avec docs/guides/usage_examples.py

Pour les contributeurs (2-3 heures):
  1. Lire tout ce qui précède
  2. docs/guides/refactoring_guide.py                → Principes de design
  3. Lancer docs/guides/architecture_guide.py            → Diagrammes
  4. Modifier le code source:
     - models/data.py → Ajouter une nouvelle source
     - ui/comptabilite_app.py → Ajouter un nouvel état
     - utils/formatters.py → Ajouter une fonction
  5. Lancer docs/guides/import_smoke_tests.py            → Valider
  6. Créer un PR!
...
Je veux COMPRENDRE LE CODE:
  1. README.md (5 min)
  2. docs/guides/architecture_guide.py (10 min)
  3. Les .py source (30 min)

Je veux UTILISER COMME LIBRAIRIE:
  1. docs/guides/usage_examples.py (copier/coller)
  2. docs/guides/migration_mapping.py (où trouver les classes)
  3. Savoir quels imports utiliser

Je veux MODIFIER LE CODE:
  1. docs/guides/refactoring_guide.py (principes)
  2. README.md (structure)
  3. Le fichier source
  4. docs/guides/import_smoke_tests.py (valider)

Je veux AJOUTER UNE FEATURE:
  1. docs/guides/architecture_guide.py (voir où l'ajouter)
  2. Lire le module concerné
  3. docs/guides/usage_examples.py (voir des exemples)
  4. Coder et tester
  5. docs/guides/import_smoke_tests.py (valider)
...
LONGER READ:
  ...
  ui/journal_dialogs.py         ~170 lignes      ⏱️  15 min
  ui/comptabilite_app.py            ~230 lignes      ⏱️  20 min

REFERENCE/DOCS:
  docs/guides/import_smoke_tests.py       ~200 lignes      ⏱️  10 min (à exécuter)
  docs/guides/usage_examples.py           ~250 lignes      ⏱️  20 min (à lire/copier)
  docs/guides/architecture_guide.py       ~200 lignes      ⏱️  15 min (à exécuter)
  docs/guides/refactoring_guide.py    ~150 lignes      ⏱️  15 min (à lire)
  docs/guides/project_summary.py           ~300 lignes      ⏱️  15 min (à exécuter)
  docs/guides/migration_mapping.py            ~350 lignes      ⏱️  20 min (à lire)
  docs/guides/quickstart_guide.py         ~200 lignes      ⏱️  Interactif
...
3. PUIS docs/guides/usage_examples.py → Trouvez ce que vous voulez faire
...
if __name__ == "__main__":
    ...
    print("   1. README.md")
    print("   2. Ce fichier (docs/guides/project_index.py)")
    print("   3. docs/guides/quickstart_guide.py ou python main.py")
    print("="*75 + "\n")
