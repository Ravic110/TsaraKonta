...
├─ Utilisé par: ui.comptabilite_app
...
utils/formatters.py
├─ Pas de dépendances
├─ Utilisé par: ui.journal_dialogs, ui.comptabilite_app
...
├─ Importe: config, models.data, utils.formatters, ui.journal_dialogs
├─ Utilisé par: main.py (point d'entrée)

ui/journal_dialogs.py (DialogueLigne)
├─ Importe: config, utils.formatters, pandas
└─ Utilisé par: ui.comptabilite_app (ComptabiliteApp)

main.py (point d'entrée)
└─ Importe et utilise: ui.comptabilite_app (ComptabiliteApp)
...
main.py                ~30          Point d'entrée           ui.comptabilite_app
...
ui/journal_dialogs.py          ~170         Dialogue d'édition       config, utils, pd
...
if __name__ == "__main__":
    ...
    print("  • docs/guides/usage_examples.py - 8 exemples pratiques")
    print("  • docs/guides/import_smoke_tests.py - Tests de validation")
    print("  • docs/guides/quickstart_guide.py - Menu interactif")
    print("="*75 + "\n")
