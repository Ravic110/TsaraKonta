...
def test_imports():
    ...
    test_cases = [
        ...
        ("DialogueLigne", lambda: __import__('ui.dialogs', fromlist=['DialogueLigne']).DialogueLigne),
        ("ComptabiliteApp", lambda: __import__('ui.main', fromlist=['ComptabiliteApp']).ComptabiliteApp),
